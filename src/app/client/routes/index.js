...
import {HomePage, ChooseBankPage, LoginPage, StatementPage, ErrorPage, TransactionsPage} from '../containers';
...
export default function Routes(store) {
  return (
    <Route path="/" component={App} >
      ...
      <Route path="transactions" title="Transactions" component={TransactionsPage} />
